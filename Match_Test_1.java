    ...
    public Match_Test_1() {
        for(int i = 0; i < 2; i++) {
            ...
            for(int y = 0;  y < size; y++) {
                System.out.println("Ener name of your team member.");
                ...
                try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
                    ...
                    //int[] accuracy = new int[8];
                    //int[] critical = new int[8];
                    //int[] block = new int[8];
                    //int[] pierce = new int[8];
                    //int[] pipConversion = new int[7];
                    ...
                    //pipConversion[z] = Integer.parseInt(fields_7[z]);
                ...
                if((i+1) == 1) t1Wizards.add(wizard);
                else t2Wizards.add(wizard);
            }
        }
...
private void updateAgentsAfterMatch() {
    // Update Team 1 if using AI
    if (usePPOForTeam1 && trainingMode) {
        System.out.println("Updating Team 1 AI...");
        updatePPOAgent("Team 1");  // Team 1 learns from this match
    }
    
    // Update Team 2 if using AI
    if (usePPOForTeam2 && trainingMode) {
        System.out.println("Updating Team 2 AI...");
        updatePPOAgent("Team 2");  // Team 2 learns from this match
    }
    
    // Save models periodically
    matchNumber++;
    if (matchNumber % 10 == 0) {
        System.out.println("Saving models after " + matchNumber + " matches...");
